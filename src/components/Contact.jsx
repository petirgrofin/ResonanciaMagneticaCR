...
const ContactCard = ({title, iframe_element, phone_number, schedule, weekend_schedule, whatsapp_number}) => (
    ...
    <div className='w-full sm:w-[450px] flex flex-col justify-center items-center bg-[#fffcfc] rounded-tl-[2em] rounded-tr-[2em] rounded-bl-[1.1em] rounded-br-[1.1em]'>

        {iframe_element}

        <p className='mt-8 font-jakarta font-bold text-[1.3em] xl:text-[1.5em]'>{title}</p>
        <ul className='font-jakarta space-y-2 sm:p-8 p-4 text-[1em]'>
...
const Contact = () => (
    ...
    <div className='ml-8 mr-8 sm:m-0 flex flex-col justify-center items-center gap-4'>
        <p className='font-poppins text-[1.2em] sm:text-[1.2em] uppercase text-[#2D5CFD] font-bold'>¿Dónde estamos?</p>
        <h2 className='font-jakarta text-[2em] sm:text-[2.5em] xl:text-[3.5em] font-semibold text-center'>Nuestras sedes</h2>
