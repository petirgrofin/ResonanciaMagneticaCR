...
import { phone_icon, time_icon, whatsapp_icon } from '../assets'

const ContactCard = ({title, iframe_element, phone_number, schedule, whatsapp_number}) => (

    <div className='flex flex-col justify-center items-center bg-[#fbfbfb] rounded-tl-[2em] rounded-tr-[2em] rounded-bl-[1.1em] rounded-br-[1.1em]'>

        {iframe_element}

        <p className='mt-8 font-poppins font-semibold text-[1.5em]'>{title}</p>
        <ul className='font-poppins text-[1.1em] space-y-2 p-8'>
...
const Contact = () => (
    ...
    <div className='flex flex-col justify-center items-center gap-4'>
        ...
        <h2 className='font-poppins text-[3.5em] font-semibold text-center'>Nuestras sedes</h2>
        <div className='mt-8 flex flex-row gap-24 flex-wrap items-center justify-center'>
